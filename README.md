# simpletodo
Simmple application to manage your todos
Deployed at https://chomnoue-simpletodo.herokuapp.com
...
To build the final jar and optimize the simpletodo application for production, run:
